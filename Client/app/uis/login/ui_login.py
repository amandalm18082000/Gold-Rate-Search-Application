...
"}")
        ...
        self.pushButton_Signup = QPushButton(self.frame_widgets)
        self.pushButton_Signup.setObjectName(u"pushButton")
        self.pushButton_Signup.setMinimumSize(QSize(0, 25))
        self.pushButton_Signup.setMaximumSize(QSize(16777215, 40))

        font8 = QFont()
        font8.setFamily(u"Segoe UI")
        font8.setPointSize(10)
        self.pushButton_Signup.setFont(font8)
...
"}")
        ...
        self.pushButton_Signup.setIcon(icon3)
    ...
    def retranslateUi(self, Login):
        Login.setWindowTitle(QCoreApplication.translate("Login", u"Login. MouseGold", None))
        self.pushButton_Signup.setText(QCoreApplication.translate("Login", u"Không có tài khoản", None))
        self.user_description.setText(QCoreApplication.translate("Login", u"Đăng nhập:", None))
